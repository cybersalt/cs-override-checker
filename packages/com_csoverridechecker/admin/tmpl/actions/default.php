 ...
 *
 * @var \Cybersalt\Component\Csoverridechecker\Administrator\View\Actions\HtmlView $this
 */
...
$filter   = $this->filter;
$baseView = 'index.php?option=com_csoverridechecker&view=actions';
...
<form method="get" action="<?php echo $this->escape(Route::_($baseView)); ?>" class="js-stools-form" id="csti-actions-filter-form">
    ...
    <div class="container-fluid">
        <p class="text-body-secondary mb-3"><?php echo Text::_('COM_CSOVERRIDECHECKER_ACTIONS_DESCRIPTION'); ?></p>
        <p class="text-body-secondary mb-3"><?php echo Text::_('COM_CSOVERRIDECHECKER_ACTIONS_VS_SESSIONS'); ?></p>
                ...
                <div class="d-flex flex-wrap gap-2 py-2">
                    <div class="js-stools-field-filter">
                        <select name="action_type" class="form-select" data-csti-choices
                                ...
                                onchange="this.form.submit()"
                                aria-label="<?php echo $this->escape(Text::_('COM_CSOVERRIDECHECKER_ACTIONS_COL_ACTION')); ?>">
                            <option value=""><?php echo $this->escape(Text::_('COM_CSOVERRIDECHECKER_FILTER_ANY_ACTION')); ?></option>
                    ...
                    <div class="js-stools-field-filter">
                        <select name="session_id" class="form-select" data-csti-choices
                                ...
                                onchange="this.form.submit()"
                                aria-label="<?php echo $this->escape(Text::_('COM_CSOVERRIDECHECKER_ACTIONS_COL_SESSION')); ?>">
        ...
        <?php if (empty($this->items)) : ?>
            <div class="alert alert-info">
                ...
                <?php else : ?>
                    <?php echo $this->escape(Text::_('COM_CSOVERRIDECHECKER_ACTIONS_EMPTY')); ?>
                <?php endif; ?>
            </div>
        <?php else : ?>
            <table class="table">
                <thead>
                    <tr>
                        <th><?php echo $sortLink('time', Text::_('COM_CSOVERRIDECHECKER_ACTIONS_COL_TIME')); ?></th>
                        <th><?php echo $sortLink('action', Text::_('COM_CSOVERRIDECHECKER_ACTIONS_COL_ACTION')); ?></th>
                        <th><?php echo $sortLink('session', Text::_('COM_CSOVERRIDECHECKER_ACTIONS_COL_SESSION')); ?></th>
                        <th><?php echo $this->escape(Text::_('COM_CSOVERRIDECHECKER_ACTIONS_COL_DETAILS')); ?></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row->session_id) : ?>
                                    <a href="<?php echo $this->escape(Route::_('index.php?option=com_csoverridechecker&view=session&id=' . (int) $row->session_id . '&from=actions', false)); ?>">
                            ...
                            <td>
                                <?php if (!empty($row->details)) : ?>
                                    <small><code class="csoverridechecker-detail-code"><?php echo $this->escape($row->details); ?></code></small>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
