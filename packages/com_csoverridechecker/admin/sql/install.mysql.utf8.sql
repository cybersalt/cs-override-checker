...
CREATE TABLE IF NOT EXISTS `#__csoverridechecker_sessions` (
...
CREATE TABLE IF NOT EXISTS `#__csoverridechecker_actions` (
    `id`         INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__csoverridechecker_backups` (
    `id`           INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `session_id`   INT UNSIGNED NULL,
