...
namespace Cybersalt\Component\Csoverridechecker\Administrator\View\Actions;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        // requireView() enforces the granular csoverridechecker.view
    ...
    {
        ToolbarHelper::title(Text::_('COM_CSOVERRIDECHECKER_ACTIONS_TITLE'), 'list-2');
    }
}
