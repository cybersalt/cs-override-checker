...
$filter   = $this->filter;
$baseView = 'index.php?option=com_cstemplateintegrity&view=backups';
...
<div class="container-fluid">
            ...
            <div class="d-flex flex-wrap gap-2 py-2">
                <div class="js-stools-field-filter">
                    <select name="session_id" class="form-select" data-csti-choices
                            ...
                            onchange="document.getElementById('csti-backups-filter-form').submit()"
                            form="csti-backups-filter-form"
                            aria-label="<?php echo $this->escape(Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_SESSION')); ?>">
    ...
    <?php if (empty($this->items)) : ?>
        <div class="alert alert-info">
            ...
            <?php else : ?>
                <?php echo $this->escape(Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_EMPTY')); ?>
            <?php endif; ?>
        </div>
    <?php else : ?>
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo $sortLink('saved', Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_TIME')); ?></th>
                    <th><?php echo $sortLink('file', Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_FILE')); ?></th>
                    <th><?php echo $sortLink('size', Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_SIZE')); ?></th>
                    <th><?php echo $this->escape(Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_HASH')); ?></th>
                    <th><?php echo $sortLink('session', Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_SESSION')); ?></th>
                    <th><?php echo $this->escape(Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_COL_ACTIONS')); ?></th>
                </tr>
            </thead>
            <tbody>
                        ...
                        <td class="csti-row-actions">
                            ...
                            <?php if ($this->canWrite) : ?>
                                <button type="submit"
                                        ...
                                        title="<?php echo $this->escape(Text::sprintf('COM_CSTEMPLATEINTEGRITY_BACKUPS_RESTORE_BUTTON_TITLE', $row->file_path)); ?>"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.csti-restore-btn').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            ...
            var msg  = <?php echo json_encode((string) Text::_('COM_CSTEMPLATEINTEGRITY_BACKUPS_RESTORE_BUTTON_CONFIRM'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
